    ...
    <Dialog v-model:open="isDeleteDialogOpen">
      <DialogContent>
        ...
        <DialogFooter>
          ...
          <Button @click="closeDeleteDialog" variant="secondary"
            >Bekor qilish</Button
          >
        </DialogFooter>
      </DialogContent>
...
const fetchCertificate = async (id) =>
  (await api.get(`/certificate-sets/${id}/`)).data;
...
const openEditForm = async (manager) => {
  ...
  selectedItem.value = await fetchCertificate(manager.id);
